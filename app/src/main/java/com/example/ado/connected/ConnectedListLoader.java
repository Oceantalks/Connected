...
public class ConnectedListLoader extends AsyncTaskLoader<List<Connected>> {

    // In this class we load of all the contacts/friends from the database

    private static final String LOG_TAG = ConnectedListLoader.class.getSimpleName();
    private List<Connected> mConnectedFriendList;
    private ContentResolver mContentResolver;
    private Cursor mCursor;


    public ConnectedListLoader (Context context, Uri uri, ContentResolver contentResolver) {
        super(context);
    ...
    public List<Connected> loadInBackground() {
        ...
        mCursor = mContentResolver.query(ConnectedContract.URI_TABLE, projection, null, null, null);
        if(mCursor != null) {
